...
class LocalRepository(Repository):
    ...
    def add_target(self, role: str, targetpath: str, custom: Optional[dict] = None) -> bool:
        ...
        targetfile = TargetFile.from_file(targetpath, targetpath)
        # Robusto: add custom fields to targetfile
        if custom:
            targetfile.unrecognized_fields = custom
        try:
